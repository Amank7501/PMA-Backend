...
public class AuthController {
    ...
    public void login(@RequestBody Map<String ,Object> loginDetails,
        ...
        if ("implicit".equalsIgnoreCase(authenticationType) && username != null && password != null) {
            ...
            String authUrl = "http://localhost:4000/realms/myRealm/protocol/openid-connect/auth"
                    + "?client_id=" + clientId
                    + "&response_type=code"
    ...
    private void handleImplicitFlow(String username, String password, HttpServletResponse response) {
        ...
        setCookie(response, "access_token", accessToken, -1); // 15 minutes expiry
        setCookie(response, "refresh_token", refreshToken, -1); // 24 hours expiry
    }
