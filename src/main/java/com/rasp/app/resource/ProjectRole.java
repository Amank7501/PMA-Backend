 ...
 */
@Component
 public class ProjectRole extends BaseResource {
	...
	private String project_role_name = null;
	...
	public static String FIELD_PROJECT_ROLE_NAME = "project_role_name";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("project_role");
	...
	static {
		...
		Field project_role_nameField = new Field("project_role_name", "String");
		project_role_nameField.setRequired(true);
		metaData.addField(project_role_nameField);
		...
		metaData.setTableName("project_role");

		metaData.setCluster("rasp_db");
	}

	public ProjectRole() {this.setId(Util.getUniqueId());}
	public ProjectRole(String id) {this.setId(id);}

	public ProjectRole(ProjectRole obj) {
		this.id = obj.id;
		...
		this.project_role_name = obj.project_role_name;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(project_role_name != null)
			map.put("project_role_name", project_role_name);
		if(extra_data != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateProject_role_name(add))
			map.put("project_role_name", project_role_name);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		project_role_name = (String) map.get("project_role_name");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object project_role_nameObj = map.get("project_role_name");
		if(project_role_nameObj != null)
			project_role_name = project_role_nameObj.toString();
	...
	public String getProject_role_nameEx() {
		return project_role_name != null ? project_role_name : "";
	}
	...
	public void unSetProject_role_name() {
		this.project_role_name = null;
	}

	public boolean validateProject_role_name(boolean add) throws ApplicationException {
		if(add && project_role_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[project_role_name]");
		return project_role_name != null;
	}
	...
	public  Class<?> getResultClass() {return ProjectRoleResult.class;};
	public  Class<?> getMessageClass() {return ProjectRoleMessage.class;};
	public  Class<?> getHelperClass() {return ProjectRoleHelper.class;};
	public  Class<?> getServiceClass() {return ProjectRoleService.class;};
}