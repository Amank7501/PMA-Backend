...
@Component
 public class Label extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("label");
	...
	static {
		...
		metaData.setTableName("label");

		metaData.setCluster("rasp_db");
	}

	public Label() {this.setId(Util.getUniqueId());}
	public Label(String id) {this.setId(id);}
	...
	public boolean validateColor(boolean add) throws ApplicationException {
		if(add && color == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[color]");
		return color != null;
	}
	...
	public  Class<?> getResultClass() {return LabelResult.class;};
	public  Class<?> getMessageClass() {return LabelMessage.class;};
	public  Class<?> getHelperClass() {return LabelHelper.class;};
	public  Class<?> getServiceClass() {return LabelService.class;};
}