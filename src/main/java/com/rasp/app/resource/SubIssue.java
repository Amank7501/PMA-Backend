 ...
 */
@Component
 public class SubIssue extends BaseResource {
	...
	private String sub_issue_title = null;
	...
	public static String FIELD_ISSUE_ID = "issue_id";
	public static String FIELD_SUB_ISSUE_TITLE = "sub_issue_title";
	public static String FIELD_STATUS = "status";
	public static String FIELD_DESCRIPTION = "description";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("sub_issue");
	...
	static {
		...
		Field issue_idField = new Field("issue_id", "String");
		issue_idField.setRequired(true);
		issue_idField.setForeign(new Foreign("Issue"));
		metaData.addField(issue_idField);

		Field sub_issue_titleField = new Field("sub_issue_title", "String");
		sub_issue_titleField.setRequired(true);
		metaData.addField(sub_issue_titleField);
		...
		metaData.setTableName("sub_issue");

		metaData.setCluster("rasp_db");
	}

	public SubIssue() {this.setId(Util.getUniqueId());}
	public SubIssue(String id) {this.setId(id);}

	public SubIssue(SubIssue obj) {
		this.id = obj.id;
		...
		this.sub_issue_title = obj.sub_issue_title;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(sub_issue_title != null)
			map.put("sub_issue_title", sub_issue_title);
		if(status != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateIssue_id(add))
			map.put("issue_id", issue_id);
		if(validateSub_issue_title(add))
			map.put("sub_issue_title", sub_issue_title);
		if(status != null)
			map.put("status", status);
		if(description != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		issue_id = (String) map.get("issue_id");
		sub_issue_title = (String) map.get("sub_issue_title");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object issue_idObj = map.get("issue_id");
		if(issue_idObj != null)
			issue_id = issue_idObj.toString();

		Object sub_issue_titleObj = map.get("sub_issue_title");
		if(sub_issue_titleObj != null)
			sub_issue_title = sub_issue_titleObj.toString();
	...
	public String getIssue_idEx() {
		return issue_id != null ? issue_id : "";
	}
	...
	public void unSetIssue_id() {
		this.issue_id = null;
	}

	public boolean validateIssue_id(boolean add) throws ApplicationException {
		if(add && issue_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[issue_id]");
		return issue_id != null;
	}

	public String getSub_issue_title() {
		return sub_issue_title;
	}

	public String getSub_issue_titleEx() {
		return sub_issue_title != null ? sub_issue_title : "";
	}

	public void setSub_issue_title(String sub_issue_title) {
		this.sub_issue_title = sub_issue_title;
	}

	public void unSetSub_issue_title() {
		this.sub_issue_title = null;
	}

	public boolean validateSub_issue_title(boolean add) throws ApplicationException {
		if(add && sub_issue_title == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[sub_issue_title]");
		return sub_issue_title != null;
	}
	...
	public  Class<?> getResultClass() {return SubIssueResult.class;};
	public  Class<?> getMessageClass() {return SubIssueMessage.class;};
	public  Class<?> getHelperClass() {return SubIssueHelper.class;};
	public  Class<?> getServiceClass() {return SubIssueService.class;};
}