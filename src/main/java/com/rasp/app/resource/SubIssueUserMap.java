 ...
 */
@Component
 public class SubIssueUserMap extends BaseResource {
	...
	private String sub_issue_id = null;
	...
	public static String FIELD_SUB_ISSUE_ID = "sub_issue_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("sub_issue_user_map");
	...
	static {
		...
		Field sub_issue_idField = new Field("sub_issue_id", "String");
		sub_issue_idField.setRequired(true);
		sub_issue_idField.setForeign(new Foreign("Sub_issue"));
		metaData.addField(sub_issue_idField);
		...
		metaData.setTableName("sub_issue_user_map");

		metaData.setCluster("rasp_db");
	}

	public SubIssueUserMap() {this.setId(Util.getUniqueId());}
	public SubIssueUserMap(String id) {this.setId(id);}

	public SubIssueUserMap(SubIssueUserMap obj) {
		this.id = obj.id;
		...
		this.sub_issue_id = obj.sub_issue_id;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(sub_issue_id != null)
			map.put("sub_issue_id", sub_issue_id);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		sub_issue_id = (String) map.get("sub_issue_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object sub_issue_idObj = map.get("sub_issue_id");
		if(sub_issue_idObj != null)
			sub_issue_id = sub_issue_idObj.toString();
	...
	public String getSub_issue_idEx() {
		return sub_issue_id != null ? sub_issue_id : "";
	}
	...
	public void unSetSub_issue_id() {
		this.sub_issue_id = null;
	}

	public boolean validateSub_issue_id(boolean add) throws ApplicationException {
		if(add && sub_issue_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[sub_issue_id]");
		return sub_issue_id != null;
	}
	...
	public  Class<?> getResultClass() {return SubIssueUserMapResult.class;};
	public  Class<?> getMessageClass() {return SubIssueUserMapMessage.class;};
	public  Class<?> getHelperClass() {return SubIssueUserMapHelper.class;};
	public  Class<?> getServiceClass() {return SubIssueUserMapService.class;};
}