 ...
 */
@Component
 public class KanbanBoard extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("kanban_board");
	...
	static {
		...
		metaData.setTableName("kanban_board");

		metaData.setCluster("rasp_db");
	}

	public KanbanBoard() {this.setId(Util.getUniqueId());}
	public KanbanBoard(String id) {this.setId(id);}

	public KanbanBoard(KanbanBoard obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return KanbanBoardResult.class;};
	public  Class<?> getMessageClass() {return KanbanBoardMessage.class;};
	public  Class<?> getHelperClass() {return KanbanBoardHelper.class;};
	public  Class<?> getServiceClass() {return KanbanBoardService.class;};
}