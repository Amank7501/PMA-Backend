 ...
 */
@Component
 public class IssueUserMap extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("issue_user_map");
	...
	static {
		...
		metaData.setTableName("issue_user_map");

		metaData.setCluster("rasp_db");
	}

	public IssueUserMap() {this.setId(Util.getUniqueId());}
	public IssueUserMap(String id) {this.setId(id);}

	public IssueUserMap(IssueUserMap obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return IssueUserMapResult.class;};
	public  Class<?> getMessageClass() {return IssueUserMapMessage.class;};
	public  Class<?> getHelperClass() {return IssueUserMapHelper.class;};
	public  Class<?> getServiceClass() {return IssueUserMapService.class;};
}