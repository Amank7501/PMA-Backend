 ...
 */
@Component
 public class ListRes extends BaseResource {
	...
	public static String FIELD_LISTNAME = "listname";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("list_res");
	...
	static {
		...
		Field listnameField = new Field("listname", "String");
		listnameField.setRequired(true);
		metaData.addField(listnameField);
		...
		metaData.setTableName("list_res");

		metaData.setCluster("rasp_db");
	}

	public ListRes() {this.setId(Util.getUniqueId());}
	public ListRes(String id) {this.setId(id);}

	public ListRes(ListRes obj) {
		this.id = obj.id;
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object listnameObj = map.get("listname");
		if(listnameObj != null)
			listname = listnameObj.toString();
	...
	public boolean validateListname(boolean add) throws ApplicationException {
		if(add && listname == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[listname]");
	...
	public  Class<?> getResultClass() {return ListResResult.class;};
	public  Class<?> getMessageClass() {return ListResMessage.class;};
	public  Class<?> getHelperClass() {return ListResHelper.class;};
	public  Class<?> getServiceClass() {return ListResService.class;};
}