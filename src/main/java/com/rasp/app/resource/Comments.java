 ...
 */
@Component
 public class Comments extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("comments");
	...
	static {
		...
		metaData.setTableName("comments");

		metaData.setCluster("rasp_db");
	}

	public Comments() {this.setId(Util.getUniqueId());}
	public Comments(String id) {this.setId(id);}

	public Comments(Comments obj) {
		this.id = obj.id;
	...
	public boolean validateContent(boolean add) throws ApplicationException {
		if(add && content == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[content]");
		return content != null;
	}
	...
	public  Class<?> getResultClass() {return CommentsResult.class;};
	public  Class<?> getMessageClass() {return CommentsMessage.class;};
	public  Class<?> getHelperClass() {return CommentsHelper.class;};
	public  Class<?> getServiceClass() {return CommentsService.class;};
}