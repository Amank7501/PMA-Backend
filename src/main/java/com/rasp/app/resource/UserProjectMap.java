 ...
 */
@Component
 public class UserProjectMap extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("user_project_map");
	...
	static {
		...
		metaData.setTableName("user_project_map");

		metaData.setCluster("rasp_db");
	}

	public UserProjectMap() {this.setId(Util.getUniqueId());}
	public UserProjectMap(String id) {this.setId(id);}

	public UserProjectMap(UserProjectMap obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return UserProjectMapResult.class;};
	public  Class<?> getMessageClass() {return UserProjectMapMessage.class;};
	public  Class<?> getHelperClass() {return UserProjectMapHelper.class;};
	public  Class<?> getServiceClass() {return UserProjectMapService.class;};
}