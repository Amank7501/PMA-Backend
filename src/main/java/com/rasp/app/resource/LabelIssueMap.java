 ...
 */
@Component
 public class LabelIssueMap extends BaseResource {
	...
	public static String FIELD_LABEL_ID = "label_id";
	public static String FIELD_ISSUE_ID = "issue_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("label_issue_map");
	...
	static {
		...
		Field label_idField = new Field("label_id", "String");
		label_idField.setRequired(true);
		label_idField.setForeign(new Foreign("Label"));
		metaData.addField(label_idField);
		...
		metaData.setTableName("label_issue_map");

		metaData.setCluster("rasp_db");
	}

	public LabelIssueMap() {this.setId(Util.getUniqueId());}
	public LabelIssueMap(String id) {this.setId(id);}

	public LabelIssueMap(LabelIssueMap obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		label_id = (String) map.get("label_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object label_idObj = map.get("label_id");
		if(label_idObj != null)
			label_id = label_idObj.toString();
	...
	public String getLabel_idEx() {
		return label_id != null ? label_id : "";
	}
	...
	public boolean validateLabel_id(boolean add) throws ApplicationException {
		if(add && label_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[label_id]");
	...
	public  Class<?> getResultClass() {return LabelIssueMapResult.class;};
	public  Class<?> getMessageClass() {return LabelIssueMapMessage.class;};
	public  Class<?> getHelperClass() {return LabelIssueMapHelper.class;};
	public  Class<?> getServiceClass() {return LabelIssueMapService.class;};
}