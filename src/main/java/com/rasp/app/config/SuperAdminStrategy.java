...
public class SuperAdminStrategy extends RoleStrategy {
    ...
    public boolean hasAccess(String role, String action, String resourceType, String resourceId, String userId) throws Exception {
        ...
        if(resourceType.equalsIgnoreCase("project")|| resourceType.equalsIgnoreCase("comments")|| resourceType.equalsIgnoreCase("issue")||resourceType.equalsIgnoreCase("list_res")||resourceType.equalsIgnoreCase("list")){
            if(action.equalsIgnoreCase("GET_BY_ID") || action.equalsIgnoreCase("GET_ALL")|| action.equalsIgnoreCase("add")){
                return true;
            }
        }
        return false;
