 ...
 */
 public class ProjectHelper extends BaseHelper {
		public ProjectHelper() {super(new Project());}
		private static ProjectHelper instance;
		public static ProjectHelper getInstance() {if (instance == null)	{instance = new ProjectHelper();register_birecord();} return instance;}
