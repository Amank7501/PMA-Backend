...
public class LabelIssueDecTest {
    ...
    @Test
    void test_fetch_label_issue_map_neg() throws Exception {
        // Perform the GET request with query parameters
        mockMvc.perform(get("/api/label_issue_map")
                        .param("queryId", "GET_LABEL_BY_ISSUE_ID")
    ...
    @Test
    void test_fetch_issue_label_map() throws Exception {
        // Perform the GET request with query parameters
        mockMvc.perform(get("/api/label_issue_map")
    ...
    @Test
    void test_fetch_issue_label_map_neg() throws Exception {
        // Perform the GET request with query parameters
        mockMvc.perform(get("/api/label_issue_map")
                        .param("queryId", "GET_ISSUE_BY_LABEL_ID")
                        .param("args", "not_id:admin11122")
